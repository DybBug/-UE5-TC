...
#pragma region Getter
	...
	FORCEINLINE int32 FindDiscoveredNodeSortingCost(uint32 _index) const  { return m_DiscoveredNodeSortingCosts.IsValidIndex(_index) ? m_DiscoveredNodeSortingCosts[_index] : GridPathfinding::INVALID_SORTING_COST;}
